...
@Autonomous(name="Autonomous Failsafe For Both Colors", group="1 Both")  // @Autonomous(...) is the other common choice
@Disabled
public class autonomousFailsafe extends LinearOpMode {
